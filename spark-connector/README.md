...
The Spark Connector JAR must also be available in order to load the JAR and send it to Spark. To do this you must download the JAR from [Maven](https://mvnrepository.com/artifact/com.vertica.spark/vertica-spark) and place it in the ```spark-connector/``` directory.
...
spark = (SparkSession.builder
    ...
    .config("spark.jars", "/spark-connector/vertica-spark-<VERSION>.jar")
    .getOrCreate())
